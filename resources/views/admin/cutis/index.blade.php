            ...
            <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
                <thead>
                    <tr>
                        ...
                        <th scope="col">No</th>
                        <th scope="col">Nama Tipe Cuti</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="text-md mb-0 fw-medium flex-grow-1">{{ $cuti->name }}</h6>
                                </div>
                            </td>
                            <td>
                                @if ($cuti->status == "active")
                                <span class="bg-success-focus text-success-main px-24 py-4 rounded-pill fw-medium text-sm">{{ ucfirst($cuti->status) }}</span>
                                @else
                                <span class="bg-danger-focus text-danger-main px-24 py-4 rounded-pill fw-medium text-sm">{{ ucfirst($cuti->status) }}</span>
