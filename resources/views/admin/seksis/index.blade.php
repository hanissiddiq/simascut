...
{{-- ========== start content =========== --}}
    <div class="card basic-data-table">
      <div class="card-header flex flex-wrap align-items-center  gap-2 justify-content-between ">
        <a href="#" class="btn btn-primary ">Tambah Seksi</a>
      </div>
        ...
        <table class="table bordered-table mb-0" id="dataTable" data-page-length='10'>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td> <span class="bg-success-focus text-success-main px-24 py-4 rounded-pill fw-medium text-sm">{{ ucfirst($seksi->status) }}</span> </td>
              <td>
