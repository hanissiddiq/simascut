        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title mb-0">Edit Data Seksi</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('seksi.update',$seksi->id) }}" method="POST">
                        ...
                        <div class="col-12 mb-1">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $seksi->name }}">
                        </div>
                        <div class="col-12 mb-1">
                            <label class="form-label">Status</label>
                            <select class="form-control" name="status">
                                <option value="active" {{ $seksi->status == 'active' ? 'selected' : '' }}>Active</option>
                                <option value="unactive" {{ $seksi->status == 'unactive' ? 'selected' : '' }}>Unactive</option>
